...
CREATE TABLE signals (
  ...
  check_interval INTEGER NOT NULL DEFAULT 60 CHECK (check_interval BETWEEN 1 AND 3600),
...
CREATE INDEX idx_signals_analysis_time ON signals(user_id, last_analysis_time) WHERE result IS NULL;
...
-- Create signal validation trigger
